...
public class BinarySearchTree<T extends Comparable<T>> implements BinaryTree<T> {
	 ...
	 *
	 * @return a String containing the dot definition of the graph.
	 */
	...
	/**
	 *
	 * @return an enumeration of the elements in sorted order
	 */
	...
	/**
	 * @param current a Node to delete from the tree
