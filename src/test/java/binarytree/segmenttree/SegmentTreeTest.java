...
public class SegmentTreeTest {
    ...
    public void rangeMinQuery() {
        ...
        SegmentTree<Integer> segmentTree = rangeMinQuery(a);
        segmentTree.print();
    ...
    public void rangeUpdate() {
        Integer[] a = new Integer[] {0, 1, 3, 5, 7, 9, 11};
        SegmentTree<Integer> segmentTree = rangeSumQuery(a);
    ...
    private SegmentTree<Integer> rangeMinQuery(Integer[] a) {
        return new SegmentTree<Integer>(a) {
    ...
    private SegmentTree<Integer> rangeSumQuery(Integer[] a) {
        return new SegmentTree<Integer>(a) {
            public Integer neutralElement() {
                return 0;
            }
