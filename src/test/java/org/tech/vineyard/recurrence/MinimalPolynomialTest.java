...
import org.tech.vineyard.recurrence.MinimalPolynomial;
...
public class MinimalPolynomialTest {
	...
	public void minimalPolynomial() {
		...
		assertEquals(Arrays.asList(COEF),
				minimalPolynomial.coefficients());

		int n1 = 5, n2 = 2000;
		assertEquals(SEQ[n1], minimalPolynomial.get(n1));
		assertEquals(Integer.valueOf(235003512), minimalPolynomial.get(n2));
	}
}